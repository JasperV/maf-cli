...
function runNPM( command ) {
  const spinner = getSpinner( `Running NPM` ).start()
  ...
  spinner.succeed( `NPM was run successfully` )
}

function initGit( repo ) {
  const spinner = getSpinner( `Running Git` ).start()
  ...
  spinner.succeed( `Git was run successfully` )
}
