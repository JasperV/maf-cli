...
// TODO: create .editorconfig, .env, .gitignore
...
async function init( done ) {
  ...
  await createFiles( getFiles( path, language, metadata ) )
...
function getFiles( path, language, metadata ) {
  return {
    [ `${path}/Localization/en-eu.strings` ]: `// EN`
  , [ `${path}/javascript/theme.js` ]: `// theme`
  , [ `${path}/javascript/core/api.js` ]: `// api`
  , [ `${path}/javascript/views/main.js` ]: `// init`
  , [ `${path}/metadata.json` ]: metadata
  , [ `${path}/Localization/${language}-eu.strings` ]: `// ${language.toUpperCase()}`
