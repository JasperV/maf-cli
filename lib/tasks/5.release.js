...
release.description = `Release your MAF App in the Metrological Dashboard. ${ansi.gray( `Not applicable if you have '` )}${ansi.yellow( `auto-release` )}${ansi.gray( `' enabled in the Metrological Dashboard.` )}`
