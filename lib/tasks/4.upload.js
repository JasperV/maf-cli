...
async function upload( done ) {
  ...
  // TODO: add date time for verification of status... otherwise when done to quickly
  // after one an other, it will grab the status of the previous upload

  // TODO: fix return format of reject calls
...
console.log( translations.error.upload.submit_errors[ error ] )
